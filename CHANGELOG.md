...
- Frontend: Added the UI refresh interaction pass with a dominant clickable forge, workshop-station navigation, ambient embers, resource deltas, recipe readiness bars, material market states, customer intent badges, and upgrade milestone states.
- Backend: Updated seeded customer type descriptions/icons so customer flavor copy is backend-owned rather than hardcoded in the frontend.
